    ...
    <div class="mx-auto grid w-full max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.2fr_1.5fr_1fr] lg:px-8">
        ...
        <div class="md:text-right">
            <div class="flex gap-2 md:justify-end">
                <a href="{{ $site['links']['github'] }}" aria-label="GitHub" data-tooltip="GitHub profilini aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip badge hover:border-[hsl(var(--accent))] hover:text-[hsl(var(--accent))]">
                ...
                <a href="{{ $site['links']['linkedin'] }}" aria-label="LinkedIn" data-tooltip="LinkedIn profilini aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip badge hover:border-[hsl(var(--accent))] hover:text-[hsl(var(--accent))]">
                ...
                <a href="{{ $site['links']['telegram'] }}" aria-label="Telegram" data-tooltip="Telegram bağlantısını aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip badge hover:border-[hsl(var(--accent))] hover:text-[hsl(var(--accent))]">
                ...
                <a href="{{ $site['links']['email'] }}" aria-label="Email" data-tooltip="E-posta gönder" target="_blank" rel="noopener noreferrer" class="icon-tooltip badge hover:border-[hsl(var(--accent))] hover:text-[hsl(var(--accent))]">
