...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    <a href="/projects" class="text-sm font-medium text-[#5DF8D8] hover:underline">Projelere dön</a>
    ...
    <section class="mt-10">
        <div class="rounded-lg border border-white/10 bg-[#101827] p-5">
            <h2 class="font-semibold text-white">Teknolojiler</h2>
    ...
    @if(count($related))
        <section class="mt-16"><h2 class="text-2xl font-semibold text-white">Benzer projeler</h2><div class="mt-6 grid gap-5 md:grid-cols-3">@foreach($related as $item) @include('partials.project-card', ['project' => $item]) @endforeach</div></section>
    @endif
</div>
@endsection
