    ...
    <div class="mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-7xl items-center gap-12 px-4 py-14 sm:px-6 lg:grid-cols-[1.18fr_0.82fr] lg:px-8 lg:py-20">
        <div class="max-w-4xl">
            ...
            <p class="mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">
                Bilgisayar mühendisliği öğrencisi olarak STM32, ESP32, C/C++, IoT ve elektronik üzerine çalışıyorum. Öğrendiklerimi projeler, teknik yazılar ve kişisel paylaşımlar halinde burada topluyorum.
            </p>
            ...
            <div class="mt-8 w-full max-w-[400px] lg:hidden">
                <div class="relative">
                    ...
                    <div class="relative rounded-[28px] border border-cyan-300/18 bg-[#101827] p-4 shadow-[0_30px_100px_-55px_#22d3ee]">
                        <img src="{{ $site['profile_image'] }}" alt="{{ $site['name'] }} profil fotoğrafı" class="aspect-[400/346] w-full rounded-[20px] object-cover sm:aspect-[400/494]">
            ...
            <div class="mt-9 grid grid-cols-1 gap-8">
                <div>
                    ...
                    <div class="mt-3 flex flex-wrap gap-3">
                        <a href="{{ $site['links']['github'] }}" aria-label="GitHub" data-tooltip="GitHub profilini aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip focus-ring inline-flex h-12 w-12 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-200 transition hover:border-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))] hover:text-[#07101f]">
                        ...
                        <a href="{{ $site['links']['linkedin'] }}" aria-label="LinkedIn" data-tooltip="LinkedIn profilini aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip focus-ring inline-flex h-12 w-12 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-200 transition hover:border-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))] hover:text-[#07101f]">
                        ...
                        <a href="{{ $site['links']['telegram'] }}" aria-label="Telegram" data-tooltip="Telegram bağlantısını aç" target="_blank" rel="noopener noreferrer" class="icon-tooltip focus-ring inline-flex h-12 w-12 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-200 transition hover:border-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))] hover:text-[#07101f]">
                        ...
                        <a href="{{ $site['links']['email'] }}" aria-label="Email" data-tooltip="E-posta gönder" target="_blank" rel="noopener noreferrer" class="icon-tooltip focus-ring inline-flex h-12 w-12 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-200 transition hover:border-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))] hover:text-[#07101f]">
        ...
        <div class="hidden justify-center lg:flex lg:justify-end">
            <div class="relative w-full max-w-[400px]">
                <div class="absolute inset-5 rounded-[28px] bg-[hsl(var(--accent)/0.18)] blur-3xl"></div>
                <div class="relative rounded-[28px] border border-cyan-300/18 bg-[#101827] p-4 shadow-[0_30px_100px_-55px_#22d3ee]">
                    <img src="{{ $site['profile_image'] }}" alt="{{ $site['name'] }} profil fotoğrafı" class="aspect-[400/494] w-full rounded-[20px] object-cover">
                    <div class="mt-4 flex justify-center">
                        <div class="rounded-full bg-[hsl(var(--accent))] px-4 py-2 text-sm font-bold text-[#07101f] shadow-lg">
                            Available for projects
                        </div>
...
<section id="expertise" class="bg-[#0a0f1e] py-16">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h2 class="mt-3 text-2xl font-extrabold tracking-normal text-white sm:text-4xl">Uzmanlık Alanlarım</h2>
    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between gap-4">
            <div>
                ...
                <h2 class="mt-3 text-2xl font-extrabold tracking-normal text-white sm:text-4xl">Öne çıkan projeler</h2>
            </div>
            <a href="/projects" class="hidden text-sm font-bold text-[hsl(var(--accent))] hover:underline sm:inline">Tüm projeler →</a>
        </div>
